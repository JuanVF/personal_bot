 ...
 */
CREATE TABLE personal_bot.t_budgets (
    id SERIAL,
    name TEXT NOT NULL,
...
ALTER TABLE ONLY personal_bot.t_budgets ADD CONSTRAINT t_budgets_pkey PRIMARY KEY (id);	
ALTER TABLE ONLY personal_bot.t_budgets ADD CONSTRAINT t_budgets_userid_fkey FOREIGN KEY (user_id) REFERENCES personal_bot.t_users(id);